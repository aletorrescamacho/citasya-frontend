  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setReservaInfo({
        ...
        hora: form.hora,
        profesional: data.cita.empleado?.nombre || "Sin asignar",
          ...
          <div className="max-w-md w-full bg-white rounded-xl shadow-lg border border-primary/10 overflow-hidden">
            <div className="p-8 text-center">
              ...
              <div className="bg-primary/5 rounded-lg p-4 border border-primary/10 text-left mb-6">
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    <span className="text-muted-foreground">ID de cita:</span>
                    <span className="font-bold text-lg">{reservaInfo.id}</span>
                  </div>
                  <div className="flex justify-between">
              ...
              <p className="text-sm text-muted-foreground mb-2">
                Guarda este ID: lo necesitarás junto con tu cédula si deseas cancelar.
              </p>
              <p className="text-sm text-muted-foreground mb-6">
                {reservaInfo.correoEnviado
                  ? "También enviamos los detalles a tu correo electrónico."
                  : "No pudimos enviar el correo, pero tu reserva fue creada correctamente."}
              </p>
