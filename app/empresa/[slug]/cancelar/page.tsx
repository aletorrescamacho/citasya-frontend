          ...
          {success ? (
            <div className="bg-white rounded-xl shadow-lg border border-primary/10 overflow-hidden p-8 text-center">
              ...
              <p className="text-gray-600 mb-6">
                {correoEnviado
                  ? "Tu cita ha sido cancelada exitosamente. Enviamos un correo de confirmación."
                  : "Tu cita ha sido cancelada exitosamente, aunque no pudimos enviar el correo de confirmación."}
              </p>
              <button
